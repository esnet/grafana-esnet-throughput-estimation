...
import { ThroughputEstimationPanel } from './ThroughputEstimationPanel';

export const plugin = new PanelPlugin<SimpleOptions>(ThroughputEstimationPanel).setPanelOptions(builder => {
  return builder
    .addTextInput({
      path: 'labelx',
      name: 'Label: X Axis',
